...
type
  TForEach<T> = reference to procedure(var AValue: T);
  TForEachIndex<T> = reference to procedure(var AValue: T; AIndex: Integer);
  TForEachBreak<T> = reference to procedure(var AValue: T; out ABreak: Boolean);
  TForEachIndexBreak<T> = reference to procedure(var AValue: T; AIndex: Integer; out ABreak: Boolean);
  ...
  TSort<T> = reference to function(AValue: T): Integer;
